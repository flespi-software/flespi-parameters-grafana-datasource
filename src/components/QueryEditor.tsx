...
import { DeviceParameter } from "./QueryEditorDeviceParameterComponent";
...
export function QueryEditor(props: QueryEditorProps<DataSource, MyQuery, MyDataSourceOptions>): ReactElement {
  ...
  return (
    <>
      ...
      <DeviceParameter datasource={datasource} query={query} onRunQuery={onRunQuery} onChange={onChange} />
